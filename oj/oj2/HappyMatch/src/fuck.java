        ...
        for (int i = 1; i <= M; i++) {   //x
            for (int j = 1; j <= N; j++) {  //y
                ...
                if (flaj != 0 && flai == 0) {
                    ...
                    if(map[i][j+3]==map[i][j]&&map[i+1][j+2]==map[i][j]&&map[i+2][j+2]==map[i][j]){
                        map[i][j+3]='0';
                        map[i+1][j+2]='0';
                        map[i+2][j+2]='0';
                    ...
                    if (map[i + 1][j + 2] == map[i][j] && map[i + 2][j + 2] == map[i][j]) {  //L down
                        map[i + 1][j + 2] = '0';
                        map[i + 2][j + 2] = '0';
                        map[i][j] = '0';
                        continue;
                ...
                if (flai != 0 && flaj == 0) {
                    ...
                    if (i - 1 > 0 && map[i + 2][j - 1] == map[i][j] && map[i + 2][j + 1] == map[i][j]) {  //dingzi1
                        map[i + 2][j - 1] = '0';
                        map[i + 2][j + 1] = '0';
                    ...
                    if(map[i+3][j]==map[i][j]&&map[i+2][j+1]==map[i][j]&&map[i+2][j+2]==map[i][j]){
                        map[i+3][j]='0';
                        map[i+2][j+1]='0';
                        map[i+2][j+2]='0';
                    } //ding2
                    ...
                    if(j-2>0&&map[i+3][j]==map[i][j]&&map[i+1][j-1]==map[i][j]&&map[i+1][j-2]==map[i][j]){
                        map[i+3][j]='0';
                        map[i+1][j-1]='0';
                        map[i+2][j-2]='0';
                    }
